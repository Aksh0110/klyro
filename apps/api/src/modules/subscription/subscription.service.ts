    ...
    const defaultPlans = [
      {
        name: 'Starter',
        code: 'STARTER',
        description: 'Ideal for single-branch gyms & studios (up to 30 members)',
        monthlyPrice: 499,
        memberLimit: 30,
        branchLimit: 1,
        features: {
      ...
      },
      {
        name: 'Growth',
        code: 'GROWTH',
        description: 'Perfect for growing gyms & club facilities (up to 500 members)',
        monthlyPrice: 799,
        memberLimit: 500,
        branchLimit: 5,
        features: {
      ...
      },
      {
        name: 'Pro',
        code: 'PRO',
        description: 'Full-featured enterprise plan for fitness chains (up to 2000 members)',
        monthlyPrice: 1199,
        memberLimit: 2000,
        branchLimit: 999,
        features: {
